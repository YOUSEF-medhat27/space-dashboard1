/* =========================================================
   ...
   Handles: sidebar/nav, NASA APOD, SpaceDevs launches,
   Solar System OpenData planets
   ========================================================= */

// ---------- CONFIG ----------
const NASA_API_KEY = "DEMO_KEY"; // swap with your own key from https://api.nasa.gov (DEMO_KEY is rate-limited)
...
// map our data-planet-id -> API id (French names for earth/saturn in that API)
const PLANET_ID_MAP = {
  mercury: "mercury",
  venus: "venus",
  earth: "terre",
...
function initPlanetCards() {
  ...
  // load Earth by default to match the static markup
  loadPlanetDetails("earth");
}
